...
integer array probeArr
integer probeIdxEnd=8192
integer probeIdxNeg=0
integer probeIdxFar=100000
integer probeIdxLast=8191
real w=0.
integer array u
integer r=0
integer array s
...
set probeArr[0]=42
call probeWriteFile("probe-arr-control.txt","control="+I2S(probeArr[0]))
endfunction
function probeReadJustPastEndThread takes nothing returns nothing
local integer probeV=probeArr[probeIdxEnd]
call probeWriteFile("probe-arr-read8192.txt","read8192="+I2S(probeV))
endfunction
function probeReadNegativeThread takes nothing returns nothing
local integer probeV=probeArr[probeIdxNeg-1]
call probeWriteFile("probe-arr-readneg.txt","readNeg="+I2S(probeV))
endfunction
function probeReadFarPastEndThread takes nothing returns nothing
local integer probeV=probeArr[probeIdxFar]
call probeWriteFile("probe-arr-readfar.txt","readFar="+I2S(probeV))
endfunction
function probeWritePastEndThread takes nothing returns nothing
set probeArr[probeIdxEnd]=7
call probeWriteFile("probe-arr-write8192.txt","wrotePastEnd")
endfunction
function probeDiscardedReadThread takes nothing returns nothing
if probeArr[probeIdxFar]>0 then
endif
call probeWriteFile("probe-arr-discarded.txt","discardedReadSurvived")
endfunction
function probeLastSlotThread takes nothing returns nothing
local integer probeV=probeArr[probeIdxLast]
call probeWriteFile("probe-arr-last.txt","lastSlot="+I2S(probeV))
endfunction
...
set Ft=null
set jt=null
call probeWriteFile("probe-arr.txt","STAGE0_REACHED_MAIN")
call ExecuteFunc("probeControlThread")
call ExecuteFunc("probeLastSlotThread")
call ExecuteFunc("probeReadJustPastEndThread")
call ExecuteFunc("probeReadNegativeThread")
call ExecuteFunc("probeReadFarPastEndThread")
call ExecuteFunc("probeWritePastEndThread")
call ExecuteFunc("probeDiscardedReadThread")
call probeWriteFile("probe-arr.txt","STAGE_ALL_DISPATCHED")
